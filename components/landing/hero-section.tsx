      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 lg:pt-24 lg:pb-28 relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Stop Spending <span className="text-gradient">6 Months</span> on Vaccine Effectiveness Studies
            </motion.h1>
            <motion.p
              variants={fadeUp(0.1)}
            ...
            <motion.div variants={fadeUp(0.15)} className="flex flex-col sm:flex-row gap-3 mb-8">
              <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.98 }}>
                <Button size="lg" className="text-base shadow-soft">
                  Start Free Trial
            ...
            <motion.div variants={fadeUp(0.2)} className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-muted-foreground">
          ...
          <div className="relative">
            ...
            <div className="relative perspective-1000">
              <motion.div
                ...
                whileHover={reduceMotion ? undefined : { rotateX: 3, rotateY: -3, y: -6 }}
